...
|---|---|
| **Squadra** | J medical |
| **Presidente** | Ciovazzocchetti |
| **`teamId`** | `8775659` |
| **Motto ufficiale** | nessuno agli atti |
| **Motto attribuito da questa testata** | «Tre portieri, un solo spogliatoio.» |
...
|---|---|---|
| **il Portierista dell'Inter** | tre portieri su tre presi dall'Inter — Martinez Jo., Provedel, Di Gennaro — per un reparto da 132 crediti, il più caro della lega | 1 |
| **lo Spettatore da 55 Crediti** | Provedel, pagato 55 crediti per una quotazione di 2, chiude senza voto in panchina in entrambe le prime due giornate | 4 |
...
|---|---|---|
| Asta 2026-27 | Tre portieri su tre dall'Inter, reparto da 132 crediti, il più caro della lega | `rosters.json` |
...
| Giornata 2 | Vittoria 4-0 sul Deportivo La Carogna con 84,5 fantapunti, il massimo di giornata alla pari con il COCA JUNIORS; secondo con 4 punti e 159 fantapunti | `matchday-02/results.json`, `standings.json` |
| Giornata 2 | Martinez Jo. (76) 7, il primo voto pieno dei tre portieri dell'Inter; Baturina (87) 11,5, Ekkelenkamp (22) 10,5, Douvikas (211) 10: tre uomini in doppia cifra, unico caso della giornata | `matchday-02/lineups.json` |

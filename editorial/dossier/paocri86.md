...
| Campo | Valore |
|---|---|
| **Squadra** | COCA JUNIORS |
| **Presidente** | PAOCRI86 |
| **`teamId`** | `5620165` |
| **Motto ufficiale** | nessuno agli atti |
| **Motto attribuito da questa testata** | «Me li sono guadagnati, non ricordo come.» |
...
|---|---|---|
| Lo Sconfitto della Settimana | 3 | Settantasette fantapunti, terzo punteggio della giornata, sei gol subiti e due titolari senza voto: nono in classifica con zero punti. |

## Precedenti notevoli

| Giornata | Il fatto | Fonte |
|---|---|---|
| Asta 2026-27 | Bilancio d'asta di 1032 crediti contro i 1000 di dotazione | `league.json`, `rosters.json` |
...
- Il tormentone dei 1032 crediti non è stato usato nel numero 3, che era pieno: resta attivo e fresco — `content/2026-27/issue-001/` — *ancora buono per:* la prima volta che il COCA JUNIORS fa mercato.
- Pulisic: tre giornate, zero voti, 160 crediti. Alla quarta è un tormentone con nome proprio — `matchday-0*/lineups.json` — *ancora buono per:* una pagella o una Mano de Dios quando torna assegnabile (numero 9).

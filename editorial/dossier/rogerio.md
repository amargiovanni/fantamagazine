...
| Campo | Valore |
|---|---|
| **Squadra** | Borussia Addurmt |
| **Presidente** | Rogerio |
| **`teamId`** | `5621158` |
| **Motto ufficiale** | nessuno agli atti |
| **Motto attribuito da questa testata** | «Ho creduto fino all'ultimo credito.» |
...
|---|---|---|
| **lo Zero in Cassa** | asta chiusa con 0 crediti residui su 1000 e 1000 spesi tondi, unico insieme a Squadra 9 a non aver lasciato niente in cassa | 1 |
| **l'Uomo del Delta Sette** | indice di rimpianto panchinaro esattamente 7,0 alla giornata 1 e 7,0 alla giornata 2, con uomini diversi e lo stesso portiere, e quattro punti raccolti | 4 |
...
- **Note:** vale la Panchina d'Oro del Disonore del numero 3. Nel numero 6: «Vergara lo avevo visto» verificata dal Casellario come esatta in ogni parte («vedere e schierare sono due operazioni distinte»); bomba Vergara e Adams C. per Provedel.

## Premi vinti

| Premio | Numero | Motivazione |
|---|---|---|
| La Panchina d'Oro del Disonore | 3 | Vergara lasciato in panchina con 12 fantapunti contro i 5 del titolare Skorupski: delta 7, il più alto della giornata. |
...
| Giornata 2 | Vittoria 1-0 sull'Aston pirla con 70,5 fantapunti, il punteggio più basso tra i cinque vincitori; quarto con 4 punti e 146 fantapunti, sesto totale della lega (Indice di Giustizia Differita +2) | `matchday-02/results.json`, `standings.json`, `content/2026-27/issue-004/classifiche.md` |
...
| Numero 6 | Casellario delle dichiarazioni: «Vergara lo avevo visto» risulta esatta, Vergara 12 in panchina è il terzo voto della giornata; pagella delle rose 5: 7,6 fantapunti ogni cento crediti, il rendimento più basso a pari merito | `content/2026-27/issue-006/approfondimento-casellario.md`, `mercato.md` |
| Numero 6 | Bomba: cede Vergara e Adams C. (2 crediti ciascuno, 12 e 10) per Provedel (55, q2) senza conguaglio — scambio inventato, cifre vere; stato `lanciata` | `content/2026-27/issue-006/bombe.md` |
